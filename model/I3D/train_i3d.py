import os
os.environ["CUDA_DEVICE_ORDER"]="2"   
import sys
import argparse
...
def run(init_lr=0.1, max_steps=64e3, mode='rgb', root='/ssd/Charades_v1_rgb', train_split='charades/charades.json', batch_size=8*4, save_model=''):
    # setup dataset
